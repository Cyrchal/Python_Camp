'''\nTworzy baze danych SQL i wypelnia ja pustymi tabelami, polaczonymi kluczami w strukture
    umozliwiajaca poruszanie sie pomiedzy jej elementami\n'''

import mysql.connector

db = mysql.connector.connect(user='root', password = 'SQLpl,okm)_0-', host='127.0.0.1', port=3306) #połączenie
